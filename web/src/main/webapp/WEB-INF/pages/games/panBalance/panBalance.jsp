...
<div class="game-container">
    ...
    <div class="game-content">
        ...
        <span class="header-mid">
            <a class="header-tool icon-toolbar-top-check"></a>
            <a class="header-tool icon-toolbar-top-print" onclick="javascript:print()"></a>
        </span>

        <span class="header-right">
            <a class="header-tool icon-toolbar-info"></a>
        </span>
        ...
        <span class="footer-left">
            <a class="footer-tool icon-toolbar-left-copy" onclick="javascript:setGameTool('copy')"></a>
            <a class="footer-tool icon-toolbar-left-group" onclick="javascript:setGameTool('group')"></a>
            <a class="footer-tool icon-toolbar-left-break" onclick="javascript:setGameTool('hammer')"></a>
        </span>
        <span class="footer-mid">
            <a class="footer-tool blank-space"></a>
            <a class="footer-tool icon-toolbar-right-erase"></a>
            <a class="footer-tool icon-toolbar-right-pen"></a>
            <a class="footer-tool icon-toolbar-right-colors"></a>
            <a class="footer-tool icon-toolbar-right-text"></a>
            <a class="footer-tool icon-toolbar-right-select" onclick="javascript:setGameTool('select')"></a>
        </span>
        <span class="footer-right">
            <a class="footer-tool icon-toolbar-delete" onclick="javascript:setGameTool('delete')"></a>
        </span>
        </div>
...
<div class="game-tools">
    <div name='toolPanel'>
        <c:if test="${param.grade eq '4'}">
            <input type="button" value="Create Mode" onclick="javascript:showModelContainer(this)"/>
        </c:if>
        <c:if test="${param.grade eq '5'}">
            &nbsp; <input type="button" value="Create Equation" onclick="javascript:showEquationContainer(this)"/>
        </c:if>
    </div>
</div>
