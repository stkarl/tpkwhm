    ...
    <div class="report-filter">
        <form:form commandName="items" action="${urlForm}" id="itemForm" method="post" autocomplete="off" name="itemForm">
            ...
            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formlUrl}"
                ...
                <display:column headerClass="table_header_center" sortName="importDate" sortable="true" titleKey="import.warehouse.date" class="text-center" style="width: 7%;">
                    <c:choose>
                ...
                <display:setProperty name="paging.banner.item_name" value="hàng hóa"/>
                <display:setProperty name="paging.banner.items_name" value="hàng hóa"/>
