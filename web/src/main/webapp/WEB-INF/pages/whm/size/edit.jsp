...
<head>
    <title><fmt:message key="whm.size.title"/></title>
    <meta name="heading" content="<fmt:message key="whm.size.title"/>"/>
</head>

<c:url var="url" value="/whm/size/edit.html"/>
<c:url var="backUrl" value="/whm/size/list.html"/>
    ...
    <div id="container-fluid data_content_box">
        <div class="row-fluid data_content">
            ...
            <div class="content-header">
                <c:choose>
                    <c:when test="${not empty item.pojo.sizeID}">
                        <fmt:message key="whm.size.edit"/>
                    </c:when>
                    <c:otherwise>
                        <fmt:message key="whm.size.new"/>
                    </c:otherwise>
                </c:choose>
            </div>
            <div class="clear"></div>
            <div class="row-fluid">
                <div class="pane_info">
                    <div class="pane_title"><fmt:message key="whm.size.info"/></div>
