...
<head>
    <title><fmt:message key="update.customer.payment"/></title>
    <meta name="heading" content="<fmt:message key="update.customer.payment"/>"/>
</head>

<c:url var="url" value="/whm/customer/updateLiability.html"/>
<div id="content">
    <form:form commandName="items" action="${url}" method="post" id="listForm" name="listForm">
        <div id="container-fluid data_content_box">
            <div class="row-fluid data_content">
                <div class="content-header">
                    <fmt:message key="update.customer.payment"/>
                </div>
                <div class="clear"></div>
                ...
                <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${url}"
                    ...
                    <display:caption><fmt:message key='update.customer.payment'/></display:caption>
                    ...
                    <display:column headerClass="table_header_center"  escapeXml="false" sortable="false" titleKey="label.pay" style="width: 10%;text-align:center;" >
                        <input type="text" class="inputFractionNumber" name="updateLiabilities[${tableList_rowNum - 1}].value" id="pay-${tableList.customerID}" onblur="calRemainOwe(this);" style="width: 90px;text-align:center;"/>
                    </display:column>
                    <display:column headerClass="table_header_center"  escapeXml="false" sortable="false" titleKey="label.own.remain" style="width: 10%;text-align:center;" >
                        <span id="remain-owe-${tableList.customerID}"></span>
                    </display:column>
                    <display:column headerClass="table_header_center"  escapeXml="false" sortable="false" titleKey="pay.date" style="width: 10%;text-align:center;">
                    ...
                    <display:column headerClass="table_header_center"  escapeXml="false" sortable="false" titleKey="label.will.pay.after.no.day" style="width: 5%;text-align:center;" >
...
<script type="text/javascript">
    ...
    function save(){
        ...
        if(checker && checkDate && isSelected){
            ...
            bootbox.alert("<fmt:message key="label.title.confirm"/>", "<fmt:message key="msg.waring.owe.incorrect"/>",function(){
            });
        }else if(!checkDate){
