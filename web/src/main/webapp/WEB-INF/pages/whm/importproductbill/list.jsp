...
<html>
<head>
    <title><fmt:message key="import.product.title"/></title>
    <meta name="heading" content="<fmt:message key='import.product.title'/>"/>
</head>
<c:url var="urlForm" value="/whm/importproductbill/list.html"></c:url>
<c:url var="previewUrl" value="/whm/importproductbill/view.html"></c:url>
<c:url var="editUrl" value="/whm/importproductbill/edit.html"></c:url>
<body>
<div class="row-fluid data_content">
    <div class="content-header"><fmt:message key="import.product.title"/></div>
    <div class="clear"></div>
        ...
        <form:form commandName="items" action="${urlForm}" id="listForm" method="post" autocomplete="off" name="listForm">
            <table class="tbReportFilter" >
                ...
                <tr>
                    ...
                    <td class="label-field" ><fmt:message key="produced.product.code"/></td>
                ...
                <tr>
                    <td class="label-field"><fmt:message key="import.product.supplier"/></td>
                    <td>
                    ...
                    <td class="label-field"><fmt:message key="import.product.receive.warehouse"/></td>
                    <td>
            ...
            <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formlUrl}"
                ...
                <display:caption><fmt:message key='import.product.list'/></display:caption>
                ...
                <display:column headerClass="table_header large" property="productionPlan.name" titleKey="whm.productionplan.name" style="width: 15%;"/>
                <display:column headerClass="table_header large" property="warehouse.name" titleKey="import.product.receive.warehouse" sortName="warehouse.name" sortable="true" style="width: 15%;"/>
                ...
                <display:column headerClass="table_header_center" sortName="soTien" sortable="true" titleKey="label.options" style="width: 7%;text-align:center;">
                    <a href="${previewUrl}?pojo.importProductBillID=${tableList.importProductBillID}" class="icon-eye-open tip-top" title="<fmt:message key="label.view"/>"></a>
                    <c:if test="${allowEdit}">
