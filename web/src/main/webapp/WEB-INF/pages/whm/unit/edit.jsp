...
<head>
    <title><fmt:message key="whm.unit.edit"/></title>
    <meta name="heading" content="<fmt:message key="whm.unit.edit"/>"/>
</head>

<c:url var="url" value="/whm/unit/edit.html"/>
<c:url var="backUrl" value="/whm/unit/list.html"/>
    ...
    <div id="container-fluid data_content_box">
        <div class="row-fluid data_content">
            ...
            <div class="content-header">
                <c:choose>
                    <c:when test="${not empty item.pojo.unitID}">
                        <fmt:message key="whm.unit.edit"/>
                    </c:when>
                    <c:otherwise>
                        <fmt:message key="whm.unit.new"/>
                    </c:otherwise>
                </c:choose>
            </div>
            <div class="clear"></div>
            <div class="row-fluid">
                <div class="pane_info">
                    <div class="pane_title"><fmt:message key="whm.unit.info"/></div>
