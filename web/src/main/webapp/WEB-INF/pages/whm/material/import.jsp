...
<head>
    <title>Nhập kho vật tư đầu kỳ</title>
    <meta name="heading" content="Nhập kho vật tư đầu kỳ"/>
</head>
<body>
<c:url var="url" value="/whm/material/import.html"/>
            ...
            <div class="row-fluid">
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <a href="<c:url value="/files/importtemplate/templateImportMaterial.xls"/>"> <fmt:message key="label.file.example"/></a>
                    </div>
                    <div class="controls">
