...
<table class="tbHskt info noscreen">
    ...
    <tr>
        ...
        <td colspan="5"><fmt:message key="label.import.back.description"/></td>
    </tr>
</table>
<table class="tableSadlier table-hover" border="1" style="width:100%;text-align: center">
    ...
    <c:forEach items="${importBackProducts}" var="importProduct" varStatus="status">
        <tr>
    ...
    <tr style="font-weight: bold;">
        ...
        <td style="text-align: center;">${fn:length(importBackProducts)} Cuộn</td>
        <td></td>
