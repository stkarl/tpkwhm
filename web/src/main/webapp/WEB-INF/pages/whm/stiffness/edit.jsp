...
<head>
    <title><fmt:message key="whm.stiffness.title"/></title>
    <meta name="heading" content="<fmt:message key="whm.stiffness.title"/>"/>
</head>

<c:url var="url" value="/whm/stiffness/edit.html"/>
<c:url var="backUrl" value="/whm/stiffness/list.html"/>
    ...
    <div id="container-fluid data_content_box">
        <div class="row-fluid data_content">
            ...
            <div class="content-header">
                <c:choose>
                    <c:when test="${not empty item.pojo.stiffnessID}">
                        <fmt:message key="whm.stiffness.edit"/>
                    </c:when>
                    <c:otherwise>
                        <fmt:message key="whm.stiffness.new"/>
                    </c:otherwise>
                </c:choose>
            </div>
            <div class="clear"></div>
            <div class="row-fluid">
                <div class="pane_info">
                    <div class="pane_title"><fmt:message key="whm.stiffness.info"/></div>
                    <div class="pane_content">
                        <div class="control-group">
                            <label class="control-label"><fmt:message key="label.name"/></label>
                            <div class="controls">
                                <form:input path="pojo.name" cssClass="required nohtml nameValidate" stiffness="25" maxlength="45"/>
                                <form:errors path="pojo.name" cssClass="error-inline-validate"/>
                            </div>
                            <label class="control-label"><fmt:message key="label.code"/></label>
                            <div class="controls">
                                <form:input path="pojo.code" cssClass="required nohtml nameValidate" stiffness="25" maxlength="45"/>
                            ...
                            <div class="controls">
                                ...
                                <div style="display: inline">
                                    ...
                                    <form:hidden path="pojo.stiffnessID"/>
