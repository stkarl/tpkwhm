...
<head>
    <title><fmt:message key="whm.team.title"/></title>
    <meta name="heading" content="<fmt:message key="whm.team.title"/>"/>
</head>

<c:url var="url" value="/whm/team/edit.html"/>
<c:url var="backUrl" value="/whm/team/list.html"/>
<form:form commandName="item" action="${url}" method="post" id="itemForm" class="form-horizontal" novalidate="novalidate">
    <div id="container-fluid data_content_box">
        <div class="row-fluid data_content">
            ...
            <div class="content-header">
                <c:choose>
                    <c:when test="${not empty item.pojo.teamID}">
                        <fmt:message key="whm.team.edit"/>
                    </c:when>
                    <c:otherwise>
                        <fmt:message key="whm.team.new"/>
                    </c:otherwise>
                </c:choose>
            </div>
            <div class="clear"></div>
            <div class="row-fluid">
                <div class="pane_info">
                    <div class="pane_title"><fmt:message key="whm.team.info"/></div>
