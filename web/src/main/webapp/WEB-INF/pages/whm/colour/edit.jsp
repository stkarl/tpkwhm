...
<head>
    <title><fmt:message key="whm.colour.title"/></title>
    <meta name="heading" content="<fmt:message key="whm.colour.title"/>"/>
</head>

<c:url var="url" value="/whm/colour/edit.html"/>
<c:url var="backUrl" value="/whm/colour/list.html"/>
    ...
    <div id="container-fluid data_content_box">
        <div class="row-fluid data_content">
            ...
            <div class="content-header">
                <c:choose>
                    <c:when test="${not empty item.pojo.colourID}">
                        <fmt:message key="whm.colour.edit"/>
                    </c:when>
                    <c:otherwise>
                        <fmt:message key="whm.colour.new"/>
                    </c:otherwise>
                </c:choose>
            </div>
            <div class="clear"></div>
            <div class="row-fluid">
                <div class="pane_info">
                    <div class="pane_title"><fmt:message key="whm.colour.info"/></div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <div style="display: inline">
                                    ...
                                    <form:hidden path="pojo.colourID"/>
