...
<head>
    <title><fmt:message key="whm.quality.title"/></title>
    <meta name="heading" content="<fmt:message key="whm.quality.title"/>"/>
</head>

<c:url var="url" value="/whm/quality/edit.html"/>
<c:url var="backUrl" value="/whm/quality/list.html"/>
    ...
    <div id="container-fluid data_content_box">
        <div class="row-fluid data_content">
            ...
            <div class="content-header">
                <c:choose>
                    <c:when test="${not empty item.pojo.qualityID}">
                        <fmt:message key="whm.quality.edit"/>
                    </c:when>
                    <c:otherwise>
                        <fmt:message key="whm.quality.new"/>
                    </c:otherwise>
                </c:choose>
            </div>
            <div class="clear"></div>
            <div class="row-fluid">
                <div class="pane_info">
                    <div class="pane_title"><fmt:message key="whm.quality.info"/></div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <div style="display: inline">
                                    ...
                                    <form:hidden path="pojo.qualityID"/>
