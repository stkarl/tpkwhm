...
<head>
    <title><fmt:message key="whm.export.product.by.plan.title"/></title>
    <meta name="heading" content="<fmt:message key="whm.export.product.by.plan.title"/>"/>
</head>

<c:url var="url" value="/whm/productionplan/productbyplan.html"/>
<c:url var="exportProductUrl" value="/whm/viewbyplan/exportproduct.html"/>
        ...
        <div id="container-fluid data_content_box">
            <div class="row-fluid data_content">
                <div class="content-header">
                    <fmt:message key="whm.export.product.by.plan.title"/>
                </div>
                <div class="clear"></div>
