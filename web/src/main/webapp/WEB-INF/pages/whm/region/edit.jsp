...
<head>
    <title><fmt:message key="whm.region.edit"/></title>
    <meta name="heading" content="<fmt:message key="whm.region.edit"/>"/>
</head>

<c:url var="url" value="/whm/region/edit.html"/>
<c:url var="backUrl" value="/whm/region/list.html"/>
    ...
    <div id="container-fluid data_content_box">
        <div class="row-fluid data_content">
            ...
            <div class="content-header">
                <c:choose>
                    <c:when test="${not empty item.pojo.regionID}">
                        <fmt:message key="whm.region.edit"/>
                    </c:when>
                    <c:otherwise>
                        <fmt:message key="whm.region.new"/>
                    </c:otherwise>
                </c:choose>
            </div>
            <div class="clear"></div>
            <div class="row-fluid">
                <div class="pane_info">
                    <div class="pane_title"><fmt:message key="whm.region.info"/></div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <div style="display: inline">
                                    ...
                                    <form:hidden path="pojo.regionID"/>
