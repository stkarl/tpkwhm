...
jQuery(function($) {
        ...
        select: function(start, end, allDay) {
            ...
            $.ajax({
                ...
                success : function(res){
                    if (res.status == "CONFIRM"|| res.status == "DRAFT"){
                        ...
                        bootbox.createEvent(labelNewWorkingPlanDetail, function(title) {
                            if (title !== null) {
                                ...
                                createDetailWorkingPlanEveryDay(null, title, start, end, allDay, date.getFullYear(), date.getMonth(), start, end, isFieldDate);
                                $('#planForm').remove();
                            }
                        });
                    }
                        ...
                        $.ajax({
                            ...
                            success: function(html){
                                    ...
                                    [
                                        {
                                            ...
                                            "callback": function() {
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    url: contextPath + "ajax/whm/workingPlanDetail/editEveryDay.html",
                                                    data: formDatas,
                                                    async: false,
                                                    success: function(res){
                                                        if (null != res){
                                                            if (null != res.success){
                                                                if (res.success){
                                                                    ...
                                                                    if ($("#subordinatesList option:selected").val() != "-1"){
                                                                        suffixTitleEvent = " - " + selectedFullName.substring(selectedFullName.lastIndexOf(" "), selectedFullName.length);
                                                                    }
                                ...
                                div.on("shown", function() {
                                    // Append option to select menu each time user choose a  day onfull calendar to create new working plan detail.
    ...
    //                            });
        ...
        viewDisplay: function(view) {
            ...
            $.ajax({
                url: contextPath + "ajax/whm/workingplan/getWorkingPlanDetailsEveryDay.html",
                dataType: "json",
                data: "year=" +selectedDate.getFullYear()+ "&month=" + selectedDate.getMonth(),
                async: false,
                success: function(res){
