...
(function ($, undefined) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        updateSelection: function (data) {
            ...
            if (formatted !== 'undefined' && formatted !== undefined) {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        postprocessResults: function (data, initial, noHighlightUpdate) {
            ...
            choices.each2(function (i, choice) {
                ...
                if (indexOf(id, val) >= 0) {
                    if(choice.hasClass("userGroup") || choice.hasClass("userItem")){
                        /*Do not hide selected item*/
                    }else{
    ...
    $.fn.select2.defaults = {
        ...
        id: function (e) { if(e != null) {return e.id;} return null; },
