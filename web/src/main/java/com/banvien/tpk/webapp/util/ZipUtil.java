    ...
    private static void zipFiles(ZipOutputStream cpZipOutputStream, File cpFile, String strSource, String strTarget) {
        ...
        if (cpFile.isDirectory()) {
            ...
            try {
                ...
                String strZipEntryName = cpFile.getName();//strAbsPath.substring(strSource.length() + 1, strAbsPath.length());
...
//
//                int index = zipName.lastIndexOf(File.separator);
//                String path = "";
//                if (index != -1) {
//                    path = zipName.substring(0, index+1);
//                }
//                FileOutputStream fos = new
//                                       FileOutputStream(path+entry);
//                dest = new
