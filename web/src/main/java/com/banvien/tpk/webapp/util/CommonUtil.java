...
public class CommonUtil {
    ...
    public static Map<Long,User> getMapCustomerUser(List<UserCustomer> userCustomers) {
        Map<Long, User> mapCustomerUser = new HashMap<Long, User>();
        if(userCustomers != null){
            for(UserCustomer uc : userCustomers){
                mapCustomerUser.put(uc.getCustomer().getCustomerID(), uc.getUser());
            }
        }
