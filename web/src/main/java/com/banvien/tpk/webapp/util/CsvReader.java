...
public class CsvReader {
  ...
  /**
   * Creates a {@link com.banvien.tpk.webapp.util.CsvReader CsvReader} object using a file
   * as the data source.
   * 
   * @param fileName
  ...
  /**
   * Constructs a {@link com.banvien.tpk.webapp.util.CsvReader CsvReader} object using a
  ...
  /**
   * Constructs a {@link com.banvien.tpk.webapp.util.CsvReader CsvReader} object using an
   ...
   * {@link com.banvien.tpk.webapp.util.CsvReader#readHeaders readHeaders()}.
   * 
  ...
  /**
   * Creates a {@link com.banvien.tpk.webapp.util.CsvReader CsvReader} object using a string
   * of data as the source.&nbsp;Uses ISO-8859-1 as the
   * {@link java.nio.charset.Charset Charset}.
   * 
   * @param data
   *            The String of data to use as the source.
   * @return A {@link com.banvien.tpk.webapp.util.CsvReader CsvReader} object using the
   ...
   * increment
   * {@link com.banvien.tpk.webapp.util.CsvReader#getCurrentRecord getCurrentRecord()}.
   * 
